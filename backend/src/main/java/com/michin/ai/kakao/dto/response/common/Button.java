...
public class Button {
	...
	protected Button(String label, String action, String webLinkUrl, String messaageText, String phoneNumber,
			String blockId) {
		this.label = label;
		this.action = action;
		this.webLinkUrl = webLinkUrl;
		this.messaageText = messaageText;
